...
<template>
  <div>
    ...
    <!-- Bottom Sheet -->
    <div v-if="showBottomSheet" class="fixed inset-0 flex justify-center items-end z-50">
      <div class="bg-white w-full max-w-lg rounded-t-lg shadow-lg p-6 relative">
        <!-- Close Button -->
        <button 
        ...
        <!-- Site Description -->
        <h2 class="text-xl font-bold mb-4">وصف الموقع</h2>
        ...
        <!-- Star Rating -->
        <div class="mb-6">
          <p class="text-lg font-semibold mb-2">تقييم المنصة </p>
