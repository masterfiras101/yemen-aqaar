    ...
    <div class="flex flex-row h-full  l overflow-x-hidden mb-12">
            <div class="grid grid-cols-1  xl:grid-cols-1   ">
                        <div class="flex  bg-white py-2 rounded-md">
                                ...
                                <div
                                class="text-xl w-full flex justify-center bg-white text-center items-center"
                                >
                                masterfiras101
        ...
        >
          <div class="flex flex-col justify-center text-center h-full overflow-x-auto mb-5">
